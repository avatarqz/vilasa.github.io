---
{"dg-publish":true,"permalink":"/deepin-md/mindful/obsidian-2026-01-23/","dgPassFrontmatter":true}
---

我想了解您在Obsidian 中
1、[[#運用到的標記方式有那些？]]
要查看md语法 加上obsidian特殊的
2、[[#如佛典中有圖表，如何繪製和處理？]]
mermaid mindmap chart draw
3、[[#Obsidian處理佛典文獻有 遇到困難嗎？如何處理？]]

sublime 技巧：差别diff, regex, fold, compile/test
[[deepin_md/resources/sublime快捷键大全 - 知乎\|sublime快捷键大全 - 知乎]]
...
| 功能      | 通用 Markdown             | Obsidian 额外或强化                                        |
| ------- | ----------------------- | ----------------------------------------------------- |
| 标题      | `# 1 #`～`###### 6 #`    | 同左；但开启「Collapse」插件后可折叠                                |
| 粗体/斜体   | `**bold**` / `*italic*` | 同左                                                    |
| 高亮      | Github支持                | ==highlight==（需在设置→外观开启）                              |
| 脚注      | `[^1]` + `[^1]: …`      | 同左；鼠标悬停可预览                                            |
| 反向链接    | `[]()`                  | `[[T1234]]` 自动建立图谱                                    |
| 别名      |                         | `[[T1234\|阿毗达摩]]`                                     |
| 嵌入块     |                         | `![[T1234#科判]]`                                       |
| callout | 无                       | `> [!info] 标题↵> 内容`                                   |
| 注释（不渲染） | 无                       | `%%这是注释%%` <!-- -->                                   |
| Mermaid | `mermaid …`             | 同左，但本地实时预览                                            |
| LaTeX   | `$行内$` / `$$块$$`        | 同左，支持 `\begin{align}`                                 |
| 属性      | 无                       | 顶部 YAML 区可写 `aliases: [阿毗达摩]` `tags: #YBh/Abhidharma` |
| 表格      | 表头                      | 同左；Obsidian 可用「Advanced Tables」插件自动对齐                 |
# 如佛典中有圖表，如何繪製和處理？

[[deepin_md/Excalidraw/Drawing 2022-11-01 14.09.21.excalidraw\|Drawing 2022-11-01 14.09.21.excalidraw]]


<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/deepin-md/mindful/2026-01-06/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
# Obsidian處理佛典文獻有 遇到困難嗎？如何處理？



# 
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/deepin-md/ebooks//readme/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
# 
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/deepin-md/mindful/2026-01-20/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
- **汉译本**：玄奘译《瑜伽师地论》卷十二至卷十五（本地分三摩呬多地）
...
三摩呬多地系统阐述了**四静虑、八解脱、三等持、十遍处**等禅定体系，其梵汉对勘不仅有助于：
...
[[Drawing 2022-11-01 14.09.21.excalidraw]]
