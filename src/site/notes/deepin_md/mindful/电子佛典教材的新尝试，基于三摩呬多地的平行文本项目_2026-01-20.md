...
三摩呬多地系统阐述了四静虑、八解脱、三等持、五现见三摩钵底等四种禅定体系，其梵汉对照有助于：
...
## 五、呈现效果与插件生态
1. 双向链接  
   Obsidian 的wiki link可反向列出所有引用该经目的论文笔记，相当于「佛教文献知识图谱」。  
2. [[#Mermaid 实时渲染]]  
   - GitHub 会自动渲染继承关系图；
...
- 未来结合 Claude Skills 与 MCP，有望把「佛教文献工程」从单纯数字化推向「可对话的知识系统」。[^kimi]
